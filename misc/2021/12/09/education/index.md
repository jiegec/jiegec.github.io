...
1. 喜欢计算机，希望从事计算机方面的工作
1. 计算机系分高，大家都说好，那我就选择去这里吧
1. 我是竞赛保送的，所以来到了这里

学校希望计算机系培养出来的学生：

1. 有很好的能力
1. 有很好的毕业去向（保研/工作/留校等等）
...
1. 想科研->找好老师->需要高 GPA 和或论文->每门课都要 4.0 同时还要在实验室科研->工作量特别大
1. 不想科研直接工作->工作不需要高的 GPA->放弃一些课程的可选部分->空余时间学习实用技术->面试轻松过关
1. 对未来没有想法->从众心理卷 GPA->每个课程都做可选部分->花费很多时间->没有时间做自己喜欢的事情
