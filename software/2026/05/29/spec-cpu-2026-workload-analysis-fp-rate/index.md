...
一个比较引人注目的是，709.cactus_r 的缓存缺失率较高：GCC 14 `-O3` 编译选项下，L1 ICache 的 MPKI 有 `118.6B/1423.6B*1000=83.30`，L1 DCache 的 MPKI 有 `125.6B/1423.6B*1000=88.23`，这在 SPEC FP 2026 Rate 中是独有一份的高。开 `-O3 -ljemalloc` 后，L1 DCache 的 MPKI 降低到 `111.7B/1423.6B*1000=78.46`，使得在指令数与 `-O3` 持平的情况下，获得约 3% 的性能提升。
