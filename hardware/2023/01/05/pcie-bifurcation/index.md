...
1. 寻找 datasheet 中关于 PCIe Bifurcation 的配置，找到 CFG 信号的取值
1. 找到 CPU 的引脚定义图（如 LGA1700），找到 CFG 引脚，然后找到附近的地或者电源
1. 连接跳线
...
1. 否则，如果 PCIE4 Slot 插入了设备，说明要配置为 2x8，设置 `CFG[6:5]=10`
1. 否则，说明要配置为 1x16，设置 `CFG[6:5]=11`
