...
1. Agents must eventually present all beats of a received message
1. Unless they have a higher priority message in flight or unanswered
   1. Agents must eventually accept a presented beat
   1. Agents must eventually answer a received request message
