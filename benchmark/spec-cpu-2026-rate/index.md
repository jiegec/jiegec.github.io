...
- Loongson 3C6000D @ 2.1 GHz LA664（`-O3 -flto -ljemalloc`）: [1.74](https://jia.je/benchmark/data-forky/int2026_rate1/Loongson_3C6000D_O3-flto-ljemalloc_001.txt)

服务器平台（LTO）：

- Loongson 3C6000D @ 2.1 GHz LA664（`-O3 -flto`）: [1.66](https://jia.je/benchmark/data-forky/int2026_rate1/Loongson_3C6000D_O3-flto_001.txt)

服务器平台：

- Loongson 3C6000D @ 2.1 GHz LA664（`-O3`）: [1.61](https://jia.je/benchmark/data-forky/int2026_rate1/Loongson_3C6000D_O3_001.txt)

#### Debian Trixie

桌面平台（`-march=native` + LTO + Jemalloc）：

- AMD Ryzen 7 5700X @ 4.65 GHz Zen 3（`-O3 -march=native -flto -ljemalloc`）: [3.97](https://jia.je/benchmark/data-trixie/int2026_rate1/AMD_Ryzen_7_5700X_O3-march%3Dnative-flto-ljemalloc_001.txt)
...
- Huawei Kirin X90 VM P-Core @ 2.3 GHz（`-O3 -march=native -flto -ljemalloc`）: [2.82](https://jia.je/benchmark/data-trixie/int2026_rate1/Huawei_Kirin_X90_VM_P-Core_O3-march%3Dnative-flto-ljemalloc_001.txt)
- Intel Core i7-13700K P-Core @ 5.4 GHz Raptor Cove（`-O3 -march=native -flto -ljemalloc`）: [5.56](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i7-13700K_P-Core_O3-march%3Dnative-flto-ljemalloc_001.txt)
- Intel Core i9-12900KS E-Core @ 4.1 GHz Gracemont（`-O3 -march=native -flto -ljemalloc`）: [3.00](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i9-12900KS_E-Core_O3-march%3Dnative-flto-ljemalloc_001.txt)
- Intel Core i9-12900KS P-Core @ 5.5 GHz Golden Cove（`-O3 -march=native -flto -ljemalloc`）: [5.60](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i9-12900KS_P-Core_O3-march%3Dnative-flto-ljemalloc_001.txt)
...
- AMD Ryzen 7 5700X @ 4.65 GHz Zen 3（`-O3 -flto -ljemalloc`）: [3.87](https://jia.je/benchmark/data-trixie/int2026_rate1/AMD_Ryzen_7_5700X_O3-flto-ljemalloc_001.txt)
...
- Huawei Kirin X90 VM P-Core @ 2.3 GHz（`-O3 -flto -ljemalloc`）: [2.80](https://jia.je/benchmark/data-trixie/int2026_rate1/Huawei_Kirin_X90_VM_P-Core_O3-flto-ljemalloc_001.txt)
- Intel Core i5-1135G7 @ 4.2 GHz Willow Cove（`-O3 -flto -ljemalloc`）: [3.35](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i5-1135G7_O3-flto-ljemalloc_001.txt)
- Intel Core i7-13700K P-Core @ 5.4 GHz Raptor Cove（`-O3 -flto -ljemalloc`）: [5.36](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i7-13700K_P-Core_O3-flto-ljemalloc_001.txt)
...
- Intel Core i9-12900KS E-Core @ 4.1 GHz Gracemont（`-O3 -flto -ljemalloc`）: [2.97](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i9-12900KS_E-Core_O3-flto-ljemalloc_001.txt)
- Intel Core i9-12900KS P-Core @ 5.5 GHz Golden Cove（`-O3 -flto -ljemalloc`）: [5.43](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i9-12900KS_P-Core_O3-flto-ljemalloc_001.txt)
...
- Intel Core i9-14900K P-Core @ 6.0 GHz Raptor Cove（`-O3 -flto -ljemalloc`）: [6.03](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i9-14900K_P-Core_O3-flto-ljemalloc_001.txt)
- Intel Xeon w9-3595X @ 4.5 GHz Golden Cove（`-O3 -flto -ljemalloc`）: [4.45](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Xeon_w9-3595X_O3-flto-ljemalloc_001.txt)

桌面平台（LTO）：

- AMD Ryzen 7 5700X @ 4.65 GHz Zen 3（`-O3 -flto`）: [3.66](https://jia.je/benchmark/data-trixie/int2026_rate1/AMD_Ryzen_7_5700X_O3-flto_001.txt)
...
- Huawei Kirin X90 VM P-Core @ 2.3 GHz（`-O3 -flto`）: [2.63](https://jia.je/benchmark/data-trixie/int2026_rate1/Huawei_Kirin_X90_VM_P-Core_O3-flto_001.txt)
- Intel Core i5-1135G7 @ 4.2 GHz Willow Cove（`-O3 -flto`）: [3.14](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i5-1135G7_O3-flto_001.txt)
- Intel Core i7-13700K P-Core @ 5.4 GHz Raptor Cove（`-O3 -flto`）: [5.07](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i7-13700K_P-Core_O3-flto_001.txt)
...
- Intel Core i9-12900KS E-Core @ 4.1 GHz Gracemont（`-O3 -flto`）: [2.79](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i9-12900KS_E-Core_O3-flto_001.txt)
- Intel Core i9-12900KS P-Core @ 5.5 GHz Golden Cove（`-O3 -flto`）: [5.11](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i9-12900KS_P-Core_O3-flto_001.txt)
...
- Intel Core i9-14900K P-Core @ 6.0 GHz Raptor Cove（`-O3 -flto`）: [5.71](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i9-14900K_P-Core_O3-flto_001.txt)
- Intel Xeon w9-3595X @ 4.5 GHz Golden Cove（`-O3 -flto`）: [4.17](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Xeon_w9-3595X_O3-flto_001.txt)

桌面平台：

- AMD Ryzen 7 5700X @ 4.65 GHz Zen 3（`-O3`）: [3.53](https://jia.je/benchmark/data-trixie/int2026_rate1/AMD_Ryzen_7_5700X_O3_001.txt)
...
- Huawei Kirin X90 VM P-Core @ 2.3 GHz（`-O3`）: [2.54](https://jia.je/benchmark/data-trixie/int2026_rate1/Huawei_Kirin_X90_VM_P-Core_O3_001.txt)
- Intel Core i5-1135G7 @ 4.2 GHz Willow Cove（`-O3`）: [3.08](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i5-1135G7_O3_001.txt)
- Intel Core i7-13700K P-Core @ 5.4 GHz Raptor Cove（`-O3`）: [4.96](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i7-13700K_P-Core_O3_001.txt)
...
- Intel Core i9-12900KS P-Core @ 5.5 GHz Golden Cove（`-O3`）: [5.00](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i9-12900KS_P-Core_O3_001.txt)
...
- Intel Core i9-14900K P-Core @ 6.0 GHz Raptor Cove（`-O3`）: [5.59](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Core_i9-14900K_P-Core_O3_001.txt)
- Intel Xeon w9-3595X @ 4.5 GHz Golden Cove（`-O3`）: [4.09](https://jia.je/benchmark/data-trixie/int2026_rate1/Intel_Xeon_w9-3595X_O3_001.txt)
...
- Kunpeng 920 HuaweiCloud kc2 @ 2.9 GHz（`-O3 -march=native -flto -ljemalloc`）: [2.68](https://jia.je/benchmark/data-trixie/int2026_rate1/Kunpeng_920_HuaweiCloud_kc2_O3-march%3Dnative-flto-ljemalloc_001.txt)
...
1. Gracemont(Intel 12900KS E-Core/Intel 14900K E-Core): MPKI=2.44
1. Cascade Lake(Intel 10980XE): MPKI=2.70
1. Broadwell(Intel E5-2680 v4): MPKI=2.94
1. Zen 1(AMD 7551): MPKI=3.73

ARM64 平台的分支预测准确率（Average）由高到低（`-O3`）：

1. Neoverse V3(AWS Graviton 5): MPKI=1.83
1. Avalanche(Apple M2 P-Core): MPKI=2.04
1. Firestorm(Apple M1 P-Core): MPKI=2.80
1. TSV110(Hisilicon Kunpeng 920): MPKI=4.07
...
- [GCC 14.2.0](https://jia.je/benchmark/data-trixie/others/SPEC_INT_2026_Intel_i9-12900KS_O3_GCC_14.txt)
- [GCC 15.2.0](https://jia.je/benchmark/data-trixie/others/SPEC_INT_2026_Intel_i9-12900KS_O3_GCC_15.txt)
- [GCC 16.1.0](https://jia.je/benchmark/data-trixie/others/SPEC_INT_2026_Intel_i9-12900KS_O3_GCC_16.txt)
- [LLVM 19.1.7](https://jia.je/benchmark/data-trixie/others/SPEC_INT_2026_Intel_i9-12900KS_O3_LLVM_19.txt)
- [LLVM 20.1.8](https://jia.je/benchmark/data-trixie/others/SPEC_INT_2026_Intel_i9-12900KS_O3_LLVM_20.txt)
- [LLVM 21.1.8](https://jia.je/benchmark/data-trixie/others/SPEC_INT_2026_Intel_i9-12900KS_O3_LLVM_21.txt)
- [LLVM 22.1.6](https://jia.je/benchmark/data-trixie/others/SPEC_INT_2026_Intel_i9-12900KS_O3_LLVM_22.txt)
...
- Intel Core i5-1135G7 @ 4.2 GHz Willow Cove（`-O3 -march=native`）: [5.22](https://jia.je/benchmark/data-trixie/fp2026_rate1/Intel_Core_i5-1135G7_O3-march%3Dnative_001.txt)
...
- Intel Core i9-12900KS E-Core @ 4.1 GHz Gracemont（`-O3 -march=native`）: [3.99](https://jia.je/benchmark/data-trixie/fp2026_rate1/Intel_Core_i9-12900KS_E-Core_O3-march%3Dnative_001.txt)
- Intel Core i9-12900KS P-Core @ 5.5 GHz Golden Cove（`-O3 -march=native`）: [8.27](https://jia.je/benchmark/data-trixie/fp2026_rate1/Intel_Core_i9-12900KS_P-Core_O3-march%3Dnative_001.txt)
...
- Intel Xeon w9-3595X @ 4.5 GHz Golden Cove（`-O3 -march=native`）: [6.34](https://jia.je/benchmark/data-trixie/fp2026_rate1/Intel_Xeon_w9-3595X_O3-march%3Dnative_001.txt)
...
- Intel Core i5-1135G7 @ 4.2 GHz Willow Cove（`-O3`）: [4.11](https://jia.je/benchmark/data-trixie/fp2026_rate1/Intel_Core_i5-1135G7_O3_001.txt)
...
- Intel Core i9-12900KS E-Core @ 4.1 GHz Gracemont（`-O3`）: [3.47](https://jia.je/benchmark/data-trixie/fp2026_rate1/Intel_Core_i9-12900KS_E-Core_O3_001.txt)
- Intel Core i9-12900KS P-Core @ 5.5 GHz Golden Cove（`-O3`）: [6.70](https://jia.je/benchmark/data-trixie/fp2026_rate1/Intel_Core_i9-12900KS_P-Core_O3_001.txt)
...
- Intel Xeon w9-3595X @ 4.5 GHz Golden Cove（`-O3`）: [5.01](https://jia.je/benchmark/data-trixie/fp2026_rate1/Intel_Xeon_w9-3595X_O3_001.txt)
...
- [GCC 14.2.0](https://jia.je/benchmark/data-trixie/others/SPEC_FP_2026_Intel_i9-12900KS_O3_GCC_14.txt)
- [GCC 15.2.0](https://jia.je/benchmark/data-trixie/others/SPEC_FP_2026_Intel_i9-12900KS_O3_GCC_15.txt)
- [GCC 16.1.0](https://jia.je/benchmark/data-trixie/others/SPEC_FP_2026_Intel_i9-12900KS_O3_GCC_16.txt)
- [LLVM 20.1.8](https://jia.je/benchmark/data-trixie/others/SPEC_FP_2026_Intel_i9-12900KS_O3_LLVM_20.txt)
- [LLVM 21.1.8](https://jia.je/benchmark/data-trixie/others/SPEC_FP_2026_Intel_i9-12900KS_O3_LLVM_21.txt)
- [LLVM 22.1.6](https://jia.je/benchmark/data-trixie/others/SPEC_FP_2026_Intel_i9-12900KS_O3_LLVM_22.txt)
